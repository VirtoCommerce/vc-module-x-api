...
{
    public class FacetRangeType : ExtendableGraphType<FacetRange>
    {
        public FacetRangeType()
        {
            ...
            Field(d => d.From, nullable: true).Description("The range’s lower endpoint in number format");
            ...
            Field(d => d.To, nullable: true).Description("The range’s upper endpoint in number format");
