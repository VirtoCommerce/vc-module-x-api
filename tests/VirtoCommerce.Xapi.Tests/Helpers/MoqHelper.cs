...
namespace VirtoCommerce.Xapi.Tests.Helpers
{
    public class MoqHelper
    {
        ...
        private const string _cultureName = "en-US";
        private const string _defaultStoreId = "default";

        private readonly Mock<IMediator> _mediatorMock = new Mock<IMediator>();
        private readonly Mock<IDataLoaderContextAccessor> _dataLoaderContextAccessorMock = new Mock<IDataLoaderContextAccessor>();

        public MoqHelper()
        {
            _fixture.Register(() => new Language(_cultureName));
            _fixture.Register(() => new Currency(_fixture.Create<Language>(), _currencyCode)
            {
